...
require(
   // Use this raphael.lonce library to "fix" some annoying things about Raphel paper and graphical elements:
    ...
    function (tutSndFactory, raphHelper) {
        ...
        // replace the black rectangle with an image for a new background
        var bgImage = paper.image("resources/bg.png", 0, 0, pWidth, pHeight);
        ...
        var dot = paper.image("resources/character.png", pWidth/2-40, pHeight/2-40, 80, 80);
        //-------------------
        ...
        dot.xpos=pWidth/2-40;
        dot.ypos=pHeight/2-40;
        dot.xrate=5;
        dot.yrate=5;
        ...
        var draw = function(){
            ...
            dot.attr({'x': dot.xpos, 'y': dot.ypos});
        ...
        // pop up box before start of game
        confirm("Click the character as many time as possible! Press the start button to start!");
